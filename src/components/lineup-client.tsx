                ...
                if (!vs.slot) {
                  return (
                    ...
                    >
                      ...
                      <div className="chip-name">Boş</div>
                      <div className="chip-pts">−4</div>
                    </div>
                  );
                }

                const s = vs.slot;
                const empty = s.isEmpty || s.playerId === null;
                const name = s.playerName;

                return (
                  <div
                    key={s.id}
                    className={`chip${empty ? " empty" : ""}`}
                    style={{ left: `${vs.x}%`, top: `${vs.y}%` }}
                  >
                    ...
                    <div className="chip-name">
                      {empty ? "Boş Slot" : lastName(name)}
                    </div>
                    <div className="chip-pts">
                      {empty
                        ? "−4 Puan"
                        : `${s.points > 0 ? "+" : ""}${s.points}`}
                    </div>
